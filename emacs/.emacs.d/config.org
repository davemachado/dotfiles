...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package org
      ...
      (setq my/org-gtd-file "~/Dropbox/emacs/gtd.org")
      (setq my/org-someday-file "~/Dropbox/emacs/someday.org")
      (setq my/org-tickler-file "~/Dropbox/emacs/tickler.org")

      (setq org-agenda-files '("~/Dropbox/emacs/inbox.org"
                               "~/Dropbox/emacs/gtd.org"
                               "~/Dropbox/emacs/tickler.org"))    
